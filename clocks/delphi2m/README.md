...
[![Code License: MIT](https://img.shields.io/badge/Code%20License-MIT-blue)](https://opensource.org/license/mit)
[![Weights License: CC BY-NC-ND 4.0](https://img.shields.io/badge/Weights%20License-CC%20BY--NC--ND%204.0-lightgrey)](https://creativecommons.org/licenses/by-nc-nd/4.0/)
...
- **Trained Delphi-2M weights** (distributed separately via UK Biobank): [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/) — non-commercial use only.
